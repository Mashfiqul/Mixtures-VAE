# -*- coding: utf-8 -*-
"""VAE_Model_Thesis_Reuters_Dataset.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Jxb0yGdij1rxXVgAxxVW6iq4ZmIxyBqj

# **VAE Model using Reuters Dataset**
"""
...
# data=scio.loadmat("/content/reuters10k.mat")
...
with open(f'Summary_Statistics_Training_{Dataset_name}.txt', 'w') as file:
    ...
    file.write(f"First Training Example: {trainset[0][0]}\n")
...
with open(f'Summary_Statistics_Test_{Dataset_name}.txt', 'w') as file:
    ...
    file.write(f"First Test Example: {testset[0][0]}\n")

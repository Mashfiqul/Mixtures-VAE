# -*- coding: utf-8 -*-
"""VAE_Model_Thesis_Digits_Dataset.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Vi-E-8DM8jUcnKiPyzzLXxWw8mjBsWem

# **VAE Model using Digits Dataset**
"""
...
Dataset_name = "Digits"
Model = "VAE"
Model_name= f"{Model}_{clustering_method}_{covariance_type}_{Dataset_name}_{random_seed}"
...
class Encoder(nn.Module):
  def __init__(self):
    ...
    self.mu_layer = nn.Linear(encoder_hidden_dim_2, latent_dim)
    self.log_var_layer = nn.Linear(encoder_hidden_dim_2, latent_dim)
...
with torch.no_grad():
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_SD_0.5.png')
  plt.close()
...
with torch.no_grad():
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_SD_1.5.png')
  plt.close()
...
with torch.no_grad():
  print("Generated Image")
  z=torch.normal(0, 2, size=(100, latent_dim), device=device)
  new_image=model.decoder(z)
  new_image=new_image.view(new_image.size(0), 1, pixel_size[0], pixel_size[1])
  new_image=new_image.cpu()
  new_image=new_image.clamp(0, 1)
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_SD_2.png')
  plt.close()
...
with torch.no_grad():
  print("Generated Image")
  z=torch.normal(0, 2.5, size=(100, latent_dim), device=device)
  new_image=model.decoder(z)
  new_image=new_image.view(new_image.size(0), 1, pixel_size[0], pixel_size[1])
  new_image=new_image.cpu()
  new_image=new_image.clamp(0, 1)
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_SD_2.5.png')
  plt.close()
...
with torch.no_grad():
  print("Generated Image")
  z=torch.normal(0, 3, size=(100, latent_dim), device=device)
  new_image=model.decoder(z)
  new_image=new_image.view(new_image.size(0), 1, pixel_size[0], pixel_size[1])
  new_image=new_image.cpu()
  new_image=new_image.clamp(0, 1)
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_SD_3.png')
  plt.close()

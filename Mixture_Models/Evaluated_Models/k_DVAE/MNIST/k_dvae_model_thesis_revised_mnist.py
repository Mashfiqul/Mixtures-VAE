# -*- coding: utf-8 -*-
"""k-DVAE_Model_Thesis_Revised_MNIST.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vopFiia96U1lAVIbP6q1kVQwTWlsxkhS

# **k-DVAE Model using MNIST Dataset**
"""
...
# Iterate through the training set to find maximum and minimum values
for data, _ in trainset:
    max_in_sample = torch.max(data)
    min_in_sample = torch.min(data)

    train_max = max(train_max, max_in_sample)
    train_min = min(train_min, min_in_sample)
...
for data, _ in testset:
    ...
    test_max = max(test_max, max_in_sample)
    test_min = min(test_min, min_in_sample)


with open('max_min_values.txt', 'w') as file:
    file.write("Training dataset:\n")
    file.write(f"Maximum value in the training dataset: {train_max}\n")
    file.write(f"Minimum value in the training dataset: {train_min}\n")
    file.write("\nTest dataset:\n")
    file.write(f"Maximum value in the test dataset: {test_max}\n")
    file.write(f"Minimum value in the test dataset: {test_min}\n")

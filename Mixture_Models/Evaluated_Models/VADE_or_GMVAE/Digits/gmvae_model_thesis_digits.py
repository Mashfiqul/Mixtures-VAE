# -*- coding: utf-8 -*-
"""GMVAE_Model_Thesis_Digits.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Bo6HjK5XrcB46omXwvFmi33rftVMZJOM

# **Gaussian Mixture Prior VAE Model using Digits Dataset**
"""
...
for epoch in range(num_epochs):
  ...
  for training_features, _ in train_loader:
    ...
    # prior_log_likelihood=torch.logsumexp(prior_lik, dim=1, keepdim=False)
    # log_p_z=torch.sum(prior_log_likelihood)
...
with torch.no_grad():
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_Std_2.png')
  plt.close()
...
with torch.no_grad():
    ...
    plt.imshow(new_image)
    plt.axis('off')
    plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_Updated_2.png')
    plt.close()
...
with torch.no_grad():
    ...
    plt.imshow(new_image)
    plt.axis('off')
    plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_Updated_3.png')
    plt.close()
